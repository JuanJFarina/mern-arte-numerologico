...
router.get('/data', function (req, res) {
  ...
  var data = {
    message: 'Hello World Nr ' + Math.floor(Math.random() * 10)
  };
...
router.post('/register', /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var _req$body, useremail, password, existingUser, newUser;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _req$body = req.body, useremail = _req$body.useremail, password = _req$body.password;
          _context3.prev = 1;
          _context3.next = 4;
          return User.findOne({
            useremail: useremail
...
router.post('/login', /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var _req$body2, useremail, password, user, isPasswordMatch;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _req$body2 = req.body, useremail = _req$body2.useremail, password = _req$body2.password;
          _context4.prev = 1;
          _context4.next = 4;
          return User.findOne({
            useremail: useremail
