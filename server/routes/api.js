...
router.post('/forgotPassword', async (req, res) => {
    ...
    const msg = {
      ...
      html: `Por favor haz clic en el enlace para setear temporalmente tu contraseña a "accesoTemporal": <a href="https://mern-arte-numerologico-apis.vercel.app/api/resetPassword/${token}/cryptedEmail">Reset Contraseña</a>`
    };
...
router.post('/resetPassword/:token/cryptedEmail', async (req, res) => {
